...
func parseFlags(options *uniq.Options) error {
	...
	flag.UintVar(&options.SkipFieldsCount, "f", 0, "skip N fields (group of characters, delimited by whitespace)")
	flag.UintVar(&options.SkipCharsCount, "s", 0, "skip N characters")
